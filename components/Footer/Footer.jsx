      ...
      <footer className="border-t-2 border-gray-600">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p className="mb-2 text-sm font-semibold uppercase tracking-[5px] lg:text-base">
                Contact
              </p>
              <a
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a
                    href="https://www.facebook.com/p/ABC-Cars-100063767991918/"
                    target="_blank"
                ...
                <li>
                  <a
                    href="https://www.instagram.com/abc__cars/"
                    target="_blank"
                    aria-label="social icon"
                  >
                    <svg
